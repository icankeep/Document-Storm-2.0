 ...
 */
public class PDFText2HTMLService extends PDFTextStripper {
	 ...
	 */
	public PDFText2HTMLService() throws IOException {
		super();
	...
	private static class FontState {
		...
		public String push(String text, List<TextPosition> textPositions) {
			...
			if (text.length() == textPositions.size()) {
				...
				// TODO change PDFTextStripper.normalize() such that it maintains the 1:1
				// relation
